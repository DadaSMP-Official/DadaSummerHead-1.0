...
**DadaSummerHead 1.0** is a custom Minecraft plugin for Paper/Spigot servers.

Custom Minecraft plugin with dedicated commands and server-side features.

| Field | Value |
| --- | --- |
| Plugin | `DadaSummerHead` |
| Version | `1.0` |
| Category | Custom Server Tool |
| Main class | `it.dadasmp.summerhead.DadaSummerHead` |
...
`release/DadaSummerHead-1.0.jar`
